...
function modal() {
  let animalsData = {
    ...
    dolmatin: {
      url: "../../assets/images/dolmatin.png",
      name: "Dalmatin",
      breed: "Dalmatin - cute dog",
      description: "This cute boy, Dalmatin, is eight years old and he likes everyone and smile all the time. He is the very best friend for everyone. Dalmatin has lots of energy, and loves to bark and play. He will enjoy every game with you.",
      age: "8 years",
      inoculations: "none",
      diseases: "none",
      parasites: "none"
